...
router.post(process.env.URL_PATH + "/addTranslation/:id", async (req, res) => {
    ...
    try {
        await session.writeTransaction(tx => tx
            .run(
                ...
                ON CREATE
                    SET translation.langTranslation= '${req.body.langTranslation}', translation.value = '${req.body.translation}', translation.note = '${req.body.noteTranslation}'
                ON MATCH
                    SET translation.langTranslation= '${req.body.langTranslation}', translation.value = '${req.body.translation}', translation.note = '${req.body.noteTranslation}'
                RETURN *
                `
            ...
            .subscribe({
                onCompleted: () => {
                    console.log("Translation added to the graph");
                },
                onError: err => {
                    console.log(err)
                }
