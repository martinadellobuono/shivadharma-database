    ...
    try {
        await session.writeTransaction(tx => tx
            .run(
                ...
                ON CREATE
                    SET commentary.location = "${req.body.chapter}${req.body.stanzaStart}${req.body.padaStart}${req.body.stanzaEnd}${req.body.padaEnd}", commentary.value = '${req.body.commentary}'
                ON MATCH
                    SET commentary.location = "${req.body.chapter}${req.body.stanzaStart}${req.body.padaStart}${req.body.stanzaEnd}${req.body.padaEnd}", commentary.value = '${req.body.commentary}'
                RETURN *
                `
