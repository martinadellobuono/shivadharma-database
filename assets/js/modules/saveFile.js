...
export const fileTextarea = () => {
    ...
    tinymce.init({
        ...
        content_style: "body {font-family:'Book Antiqua'; font-size:16px}" +
            ...
            "[data-type='annotation-object'][data-subtype='parallel'] {border-bottom-color: #FD9843;}" +
            "[data-type='annotation-object'][data-subtype='translation'] {border-bottom-color: #79DFC1;}" +
